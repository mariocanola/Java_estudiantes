...
public class Estudiante {
	 ...
	 * Los cursos del estudiante fueron inicializados con los siguientes valores:
	 * <br>
	 * Curso 1 - Código: ISIS1204, Nombre: APO1, Créditos: 3, Departamento:
	 * SISTEMAS. <br>
	 * Curso 2 - Código: MATE1203, Nombre: Cálculo diferencial, Créditos: 3,
	 * Departamento: MATEMÁTICAS. <br>
	 * Curso 3 - Código: FISI1100, Nombre: Física 1, Créditos: 4, Departamento:
	 * FISICA. <br>
	 ...
	 * 
	 * @return Promedio de los cursos que tienen nota asignada. Si ningún curso
	 *         tiene nota asignada, retorna -1.
	 */
	...
	/**
	 * Cambia el curso con el código dado por parámetro a un nuevo curso con los
	 * valores dados por parámetro. <br>
	 * Si ya existe un curso con el código que se desea asignar, no se cambiar la
	 * información del curso. <br>
	 * <b>pre: </b> Existe un curso con el código dado. <br>
	 * <b>post: </b> El curso tiene el nuevo código, nombre, créditos y departamento
	 * dados por parámetro.
	 * 
	 * @param pCodigoActual Código actual del curso a cambiar. pCodigoActual != null
	 *                      && pCodigoActual != "".
	 * @param pNuevoCodigo  Nuevo código del curso. pNuevoCodigo != null &&
	 *                      pNuevoCodigo != "".
	 ...
	 * @return Retorna true si se cambió el curso, false si no se cambió porque ya
	 *         existía un curso con el código que se deseaba asignar.
	 */
	public boolean cambiarCurso(String pCodigoActual, String pNuevoCodigo, String pNombre, int pCreditos,
