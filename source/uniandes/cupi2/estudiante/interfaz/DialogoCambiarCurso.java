...
public class DialogoCambiarCurso extends JDialog implements ActionListener {
	 ...
	 * @param pCodigoCurso Código actual del curso. pCodigoCurso != null &&
	 *                     pcodigoCurso != "".
	 */
	...
	public void actionPerformed(ActionEvent pEvento) {
		...
		if (comando.equals(ACEPTAR)) {
			...
			if (codigoActual.equals("") || codigoNuevo.equals("") || nombre.equals("") || creditosStr.equals("")) {
				JOptionPane.showMessageDialog(this, "Debe llenar todos los campos.", "Cambiar curso",
				...
				try {
					...
					if (creditos <= 0) {
						JOptionPane.showMessageDialog(this, "El número de créditos debería ser mayor a 0.",
								"Cambiar curso", JOptionPane.ERROR_MESSAGE);
					} else {
						principal.cambiarCurso(codigoActual, codigoNuevo, nombre, depto, creditos);
						dispose();
					}
				} catch (NumberFormatException e) {
					JOptionPane.showMessageDialog(this, "La cantidad de créditos debe ser un valor numérico.",
							"Cambiar curso", JOptionPane.ERROR_MESSAGE);
				}
			}
