...
public class InterfazEstudiante extends JFrame {
	 ...
	 * 
	 * @param pCodigo Código del curso que se le va a asignar la nota. pCodigo !=
	 *                null && pCodigo != "".
	 */
	public void asignarNotaCurso(String pCodigo) {
		String ingresado = JOptionPane.showInputDialog(this, "Nota obtenida en el curso:", "Asignar nota",
		...
		if (ingresado != null) {
			try {
				...
				if (nota < 0) {
					JOptionPane.showMessageDialog(this, "El valor ingresado debe ser un valor positivo.",
							"Asignar nota", JOptionPane.ERROR_MESSAGE);
				} else {
					boolean asigno = estudiante.asignarNotaCurso(pCodigo, nota);
					if (asigno == true) {
						actualizar();
					} else {
						JOptionPane.showMessageDialog(this, "La nota debe estar entre 1.5 y 5.0.", "Asignar nota",
								JOptionPane.ERROR_MESSAGE);
					}
				}
			} catch (NumberFormatException e) {
				JOptionPane.showMessageDialog(this, "Debe ingresar un valor numérico.", "Asignar nota",
						JOptionPane.ERROR_MESSAGE);
			}
		}
	}
	...
	public void estudianteEnPrueba() {
		...
		if (promedio == -1) {
			JOptionPane.showMessageDialog(this, "Debe asignar nota al menos a un curso.", "Estudiante en prueba",
					JOptionPane.INFORMATION_MESSAGE);
		} else {
			if (estaPrueba) {
				JOptionPane.showMessageDialog(this, "El estudiante se encuentra en prueba académica (promedio < 3.25).",
						"Estudiante en prueba", JOptionPane.INFORMATION_MESSAGE);
			} else {
				JOptionPane.showMessageDialog(this,
						"El estudiante no se encuentra en prueba académica (promedio >= 3.25).", "Estudiante en prueba",
						JOptionPane.INFORMATION_MESSAGE);
			}
		}
	...
	public void estudianteCandidatoBeca() {
		...
		if (promedio == -1) {
			JOptionPane.showMessageDialog(this, "Debe asignar nota al menos a un curso.", "Estudiante candidato a beca",
					JOptionPane.INFORMATION_MESSAGE);
		} else {
			if (beca) {
				JOptionPane.showMessageDialog(this, "El estudiante es candidato a beca (promedio >= 4.75).",
						"Estudiante candidato a beca", JOptionPane.INFORMATION_MESSAGE);
			} else {
				JOptionPane.showMessageDialog(this, "El estudiante no es candidato a beca (promedio < 4.75).",
						"Estudiante candidato a beca", JOptionPane.INFORMATION_MESSAGE);
			}
		}
	 ...
	 * 
	 * @param pCodigoActual Código actual del curso. pCodigoActual != null &&
	 *                      pCodigoActual != "".
	 * @param pNuevoCodigo  Código nuevo del curso. pCodigoNuevo != null &&
	 *                      pCodigoNuevo != "".
	 * @param pNombre       Nombre nuevo del curso. pNombre != "" && pNombre !=
	 *                      null.
	 * @param pDepartamento Departamento del curso. pDepartamento != null.
	 * @param pCreditos     Créditos a asignar. pCreditos >= 0.
	 */
	public void cambiarCurso(String pCodigoActual, String pNuevoCodigo, String pNombre, Departamento pDepartamento,
			int pCreditos) {
		if (estudiante.cambiarCurso(pCodigoActual, pNuevoCodigo, pNombre, pCreditos, pDepartamento)) {
			actualizar();
		} else {
			JOptionPane.showMessageDialog(this, "Ya existe un curso con código " + pNuevoCodigo + ".", "Cambiar curso",
					JOptionPane.ERROR_MESSAGE);
		}
	}
	 ...
	 * 
	 * @param pCodigoCurso Código del curso a cambiar. pCodigoCurso != "" &&
	 *                     pCodigoCurso != null.
	 */
